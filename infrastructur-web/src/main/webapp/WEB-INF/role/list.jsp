...
<%@ include file="/WEB-INF/system/nav.jsp"%>
<div class="container-fluid">
	<div class="row">
		<%@ include file="/WEB-INF/system/sidebar.jsp"%>
...
<%@include file="/WEB-INF/role/add.jsp" %>
<%@include file="/WEB-INF/role/edit.jsp" %>
<%@include file="/WEB-INF/role/delete-alert.jsp" %>
</body>
</html>